...
import LeadDetailModal from "./LeadModal";
import { PhoneIcon } from "../../icon/svg-icons";
...
const LeadsTable: React.FC<LeadsTableProps> = ({
  ...
  const handleRowClick = (lead: Lead, e: React.MouseEvent) => {
    // Evitar que se abra el modal si se hace click en los botones
              ...
              >
                ...
                <td className="py-4 px-4">
                  <div className="flex justify-center">
                    <span className={`px-3 py-1 rounded-full text-sm font-medium ${lead.status === 'active' ? 'text-green-600 bg-green-50' :
